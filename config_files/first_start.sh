...
mv /etc/php82/php-fpm.conf /etc/php82/php-fpm.conf.orig
mv /etc/php82/php-fpm.new.conf /etc/php82/php-fpm.conf
mv /etc/php82/php-fpm.d/www.conf /etc/php82/php-fpm.d/www.conf.orig
mv /etc/php82/php-fpm.d/www.new.conf /etc/php82/php-fpm.d/www.conf
