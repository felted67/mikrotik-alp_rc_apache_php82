#
# Dockerfile for alpine-linux-rc-apache2-php82 mikrotik-docker-image
# (C) 2023-2024 DL7DET
#
...
LABEL org.label-schema.name="mikrotik-alp_rc_apache_php82"
LABEL org.label-schema.url="https://cb3.lampart-web.de/internal/docker-projects/mikrotik-docker-images/mikrotik-alp_rc_apache_php82"  
...
LABEL org.label-schema.vcs-url="https://cb3.lampart-web.de/internal/docker-projects/mikrotik-docker-images/mikrotik-alp_rc_apache_php82.git" 
LABEL org.label-schema.vcs-ref=$COMMIT_SHA 
LABEL org.label-schema.docker.dockerfile="/Dockerfile" 
LABEL org.label-schema.description="alpine-linux-rc-apache-php82 mikrotik-docker-image" 
...
COPY ./config_files/php-fpm82.sh /etc/profile.d/
